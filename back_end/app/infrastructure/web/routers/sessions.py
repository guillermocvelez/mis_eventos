...
from app.domain.exceptions import EventNotFound, SessionOverlap, InvalidEventDate, CapacityExceeded, Unauthorized,SessionOutOfRange
...
def create_session(
    ...
    except (InvalidEventDate, SessionOverlap, CapacityExceeded,SessionOutOfRange) as e:
